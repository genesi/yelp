...
void
yelp_marshal_VOID__POINTER_BOOLEAN (GClosure     *closure,
...
void
yelp_marshal_VOID__STRING_INT (GClosure     *closure,
                               GValue       *return_value G_GNUC_UNUSED,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
...
void
yelp_marshal_BOOLEAN__POINTER_BOOLEAN (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
                                       gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_BOOLEAN__POINTER_BOOLEAN) (marshal_data ? marshal_data : cc->callback);
